...
def add_color_batch(inputfile, outputdir, wrapperfile, wrapperfile2):
    input_constraint = inputfile + "/DB_constraint.const" 
    ...
    for line in inFile:
        ...
        if lineCount % 2 == 1:
            ...
            inputps = inputfile + "/" + gene_id + "_ss.ps"
...
if __name__ == "__main__":
    ...
    parser.add_option("-i", "--input", dest="inputFile",
                  help="Input fastq file name, the barcode shoule be located at [3:7]", metavar="INPUT")
    ...
    add_color_batch(inputfile, outputdir, wrapperfile, wrapperfile2)
